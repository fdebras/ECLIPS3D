PROGRAM write_eigenvectors
  ...
  OPEN(unit=1,file='/home/florian/test/ECLIPS3D/2D_shallow/data/nummodes.dat', &
    access='SEQUENTIAL')
    
  OPEN(unit=2, file='/home/florian/test/ECLIPS3D/2D_shallow/data/scalapack.dat', &
    access='SEQUENTIAL')
  
  OPEN(unit=3,file='/home/florian/test/ECLIPS3D/2D_shallow/data/selected_modes.dat', & 
    access='SEQUENTIAL')
