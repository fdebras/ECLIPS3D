PROGRAM find_eigenvectors
  ...
  OPEN(unit=1,file='/home/florian/test/ECLIPS3D/2D_shallow/data/eig_sca.dat', &
    access='SEQUENTIAL')
  OPEN(unit=2, file='/home/florian/test/ECLIPS3D/2D_shallow/data/fort.43', & 
    access='SEQUENTIAL')
  OPEN(unit=5,file='/home/florian/test/ECLIPS3D/2D_shallow/data/nummodes.dat', &
    access="SEQUENTIAL")
  READ(1,*)
