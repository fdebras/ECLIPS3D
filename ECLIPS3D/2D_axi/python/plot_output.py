...
infile=open('/Users/florian/Desktop/MyWork/Results/earth_rest_2D/rho_cs_ns.dat')
...
#infile2=open('/Users/florian/Desktop/MyWork/2D_sca/data/normal_modes/selected_modes.dat')
infile2=open('/Users/florian/Desktop/MyWork/Results/earth_rest_2D/selected_modes.dat')
data2=infile2.read()
infile2.close()
...
while (a<len(values2) and stop==False) :
    ...
    if ((t>=25) and (stop==False)) :# and (np.abs(sigmai)>1.0e-5)) :
        print(t)
        n_auto=n_auto+1
